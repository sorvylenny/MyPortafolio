...
export class PortafolioComponent {
 ...
 list_Proyectos: Portafolio[]=[
  {title:'Proyectos', image:'assets/appPaises.png', text1:'App-Paises',text2:'Aplicación realizada para buscar por países, región y capital, fue mi primera aplicación.',text3:'Observación: Aplicación de práctica lo que aprendí en el Curso de Angular en Udemy.', link:'https://aplicationpaises.netlify.app/'},
 ...
 list_Icon: Portafolio[]=[
  ...
  {link:'assets/Hv-fontend-KatherineFlores-Ingles.pdf', text1:'icons8-great-britain'},
 ];
