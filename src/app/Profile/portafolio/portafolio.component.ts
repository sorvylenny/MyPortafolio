...
export class PortafolioComponent {
 ...
 list_Proyectos: Portafolio[]=[
  ...
  {video:'assets/appMovies.mp4', text1:'MoviesApp',text2:'Este proyecto es una aplicación web desarrollada en Angular que proporciona información sobre películas y series de televisión. Permite a los usuarios explorar contenido, obtener detalles sobre películas y programas de televisión, buscar títulos específicos y acceder a una variedad de funcionalidades relacionadas.', link:'https://moviesandtvapp.netlify.app/'},
  {video:'assets/appSystemSales.mp4', text1:'System Sales',text2:'SystemSales es una aplicación de gestión de ventas desarrollada con Angular, .NET y Angular Material. La aplicación incluye un sistema de autenticación, módulo de ventas, historial de ventas, generación de informes, registro de usuarios, registro de productos y visualización de ventas de las últimas semanas. Estas características están diseñadas para ser accesibles solo para los usuarios administradores. 1. Autenticación de Usuarios Login: Los usuarios pueden iniciar sesión proporcionando su correo electrónico y contraseña para el usuario admin email:prueba@example.com, clave:1234, supervisor email:prueba1@example.com, empleado email:prueba2@example.com, clave:abc123.', link:'https://github.com/sorvylenny/AppSystemSale' },
  ...
  {video:'assets/appMoviesTest.mp4', text1:'AppMoviesTest', text2:'MoviesAPP is a web application that allows users to explore a collection of movies. The application features a login system with email and password, a main page displaying movies, filtering options by title and release date, detailed information pages for each movie, a watchlist functionality, and a watchlist table for managing saved movies. Login System: Users can log in using their email:user1@example.com and password: Abc12345.', link:'https://moviesapptest.netlify.app/#/login'},
